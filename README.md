...
| 5 | [Testing / QA](docs/05-testing-qa/) | [Test plan](docs/05-testing-qa/test-plan.md) — 62 tests (component/integration + a11y) + 3 guards in CI; 14/16 AC automated | 🔬 In progress |
