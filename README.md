...
| 5 | [Testing / QA](docs/05-testing-qa/) | [Test plan](docs/05-testing-qa/test-plan.md) — 48 tests (incl. component/integration) + 3 guards in CI; 14/16 AC automated | 🔬 In progress |
