...
| 5 | Testing / QA | [`05-testing-qa/`](05-testing-qa/) | [Test plan](05-testing-qa/test-plan.md) — 87 Vitest + Playwright E2E + 3 model guards + content guard; CI gates size/audit; 14/16 AC automated | 🔬 In progress |
