...
> 🔬 **In progress.** Phase 2 of 7. Follows the
> [Discovery & Planning charter](../01-discovery-and-planning/discovery-and-planning.md).
>
> **Output:** a Software Requirements Specification (SRS).
