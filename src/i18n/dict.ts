...
export const DICT = {
  ...
  'learn.seeInCatalog': { en: 'Full explanation in the Catalog →', id: 'Penjelasan lengkap di Katalog →' },
  ...
  'learn.readingFor': { en: 'For', id: 'Untuk' },
  'learn.audience.awam': { en: 'newcomers', id: 'awam' },
  'learn.audience.expert': { en: 'experts', id: 'ahli' },
  ...
  'learn.howToAdopt': { en: 'How to adopt it', id: 'Cara mengadopsi' },
  'learn.whatToReview': { en: 'What to check when reviewing', id: 'Yang diperiksa saat meninjau' },
  'learn.playbookIntro': {
