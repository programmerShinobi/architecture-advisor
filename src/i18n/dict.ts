...
export const DICT = {
  ...
  'learn.catalogIntro': {
    en: 'every architecture the Advisor evaluates, grouped by decision — with cited journals and books for each.',
    id: 'setiap arsitektur yang dinilai Advisor, dikelompokkan per keputusan — dengan jurnal dan buku yang dikutip untuk masing-masing.',
  },
  'learn.readingHint': {
  ...
  'learn.playbookIntro': {
    en: 'Practical how-to for every architecture the Advisor evaluates — when to choose it and the first move — plus cross-cutting decision guides.',
    id: 'Panduan praktis untuk setiap arsitektur yang dinilai Advisor — kapan memilihnya dan langkah pertama — plus panduan keputusan lintas-topik.',
  },
  'learn.reviewIntro': {
    en: 'How to evaluate every architecture the Advisor evaluates — what to check and the red flags — plus review methods and checklists.',
    id: 'Cara mengevaluasi setiap arsitektur yang dinilai Advisor — yang diperiksa dan tanda bahayanya — plus metode tinjauan dan checklist.',
  },
  ...
  'section.catalog.desc': { en: 'Architecture styles and their quality-fit profiles.', id: 'Gaya arsitektur dan profil kecocokan kualitasnya.' },
  'section.playbook': { en: 'Playbook', id: 'Playbook' },
  'section.playbook.desc': { en: 'How-to guides and decision practices.', id: 'Panduan praktis dan praktik pengambilan keputusan.' },
  'section.review': { en: 'Review', id: 'Tinjauan' },
  'section.review.desc': { en: 'Checklists and methods to evaluate an architecture.', id: 'Checklist dan metode untuk mengevaluasi arsitektur.' },
  'section.library': { en: 'Library', id: 'Pustaka' },
  'section.library.desc': { en: 'Trends and deeper topics.', id: 'Tren dan topik mendalam.' },
  'section.roadmap': { en: 'Roadmap', id: 'Peta Belajar' },
  'section.roadmap.desc': { en: 'Guided learning paths.', id: 'Alur belajar terpandu.' },
  'section.academy': { en: 'Academy', id: 'Akademi' },
  'section.academy.desc': { en: 'Course modules and quizzes.', id: 'Modul kursus dan kuis.' },
  'section.lab': { en: 'Lab', id: 'Lab' },
  'section.lab.desc': { en: 'Interactive sandboxes on the engine.', id: 'Sandbox interaktif di atas mesin.' },
